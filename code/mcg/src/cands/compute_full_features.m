...
features = [curr_end_ths curr_start_ths curr_area_bal ...
  curr_areas/(b_feats.im_size(1)*b_feats.im_size(2)) curr_perims ...
  curr_th_sums curr_m_cont curr_comp curr_cs_area norm_bboxes ...
  area_bboxes area_per_bbox aspect_ratio];
end
